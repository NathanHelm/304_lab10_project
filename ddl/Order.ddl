...
INSERT INTO category(categoryName) VALUES ('Cupcakes');
INSERT INTO category(categoryName) VALUES ('Muffins'); 4
INSERT INTO category(categoryName) VALUES ('Pastry'); 5
INSERT INTO category(categoryName) VALUES ('Pies'); 6
INSERT INTO category(categoryName) VALUES ('Puddings');

INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Milk Bread', 5, 'The milk [bread] dad tried to get',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Apple Crumble', 5,'Delicious representation of Apple stock prices',15.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Raspberry Cheesecake',1,'Not as narly without the rhubarb',5.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Blueberry Pie',6,'honestly more purple, unless you're colour blind',12.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Strawberry Tart',5,'red40 sold separately',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chocolate Cupcakes',3,'not so vanilla',2.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Black Forest Cake',1,'lorex villain arc',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cranberry Tart',5,'this one has red40',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Berry Muffin',4,'not actually berries, backed by science',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Double Chocolate Cookie',2,'double trouble extravaganza',2.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chocolate Chip Cookie',2,'good ol classic. pinky promise they're not rasins',2.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cherry Pie',6,'where the red40 came from',12.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Banana Pudding',7,'peels donated to nintendo',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Lemon Tart',5,'24 - 250 ml bottles',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Raspberry Crumble',5,'just like the economy',15.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cinnamon Buns',5,'swirlies',5.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Bread Pudding',7,'baked french toast',15.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Macaron',2,'the french',2.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Salted Caramel Cookie',2,'only salty to keep it interesting',2.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chocolate Cake',1,'bean cake'25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Mango Cake',1,'witness protected',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Macadamia Cookie',1,'broke up with white chocolate',2.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Espresso Muffin',4,'enjoys jury duty',3.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Carrot Cake',1,'woke',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chocolate Pudding',7,'the hospital room special',3.00);
